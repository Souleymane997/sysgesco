...
class SendEmploiPage extends StatefulWidget {
  const SendEmploiPage({super.key, required this.eleve, required this.classe});

  final ElevesModel eleve;
  final String classe;

  @override
  State<SendEmploiPage> createState() => _SendEmploiPageState();
}

class _SendEmploiPageState extends State<SendEmploiPage> {
