...
class SaisirNotePage extends StatefulWidget {
  const SaisirNotePage({super.key, required this.eleve, required this.matiere});
  final ElevesModel eleve;
  final String matiere;

  @override
  State<SaisirNotePage> createState() => _SaisirNotePageState();
}

class _SaisirNotePageState extends State<SaisirNotePage> {
                        ...
                        Expanded(
                          child: ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                if (noteController.text.isEmpty ||
                                  ...
                                  CoolAlert.show(
                                    ...
                                    DInfo.snackBarError(
                                        "La Note $num de ${widget.eleve.nomEleve} ${widget.eleve.prenomEleve} existe deja  ... vous pouvez la modifier ",
                                        context);
                                  }
                                }
                              },
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  CustomText(" Enregistrer la note ",
                                      color: Colors.white,
